(function (f) {
    // Comment out the load logic for other environment as the define has been defined in init.js loaded by Map VIZ, which will cause problem when using wordCloud and Map together
